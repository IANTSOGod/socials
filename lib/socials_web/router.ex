defmodule SocialsWeb.Router do
  use SocialsWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {SocialsWeb.Layouts, :root}
  ...
  if Application.compile_env(:socials, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: SocialsWeb.Telemetry
